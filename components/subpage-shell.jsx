...
export default function SubpageShell({ label, title, description, children }) {
  const intro = {
    "프로그램 소개": { lines: ["문제 선택부터,", "틀린 문제를 다시 풀기까지."], points: ["필요한 기출 고르기", "힌트로 다시 풀기", "손풀이 기록", "오답 복습"] },
    "학습 자기점검": { lines: ["수능 수학, 어디서 막히나요?", "평소 공부 습관부터 살펴보세요."], points: ["5문항 · 약 30초", "선택하면 다음 질문", "세 가지 점검 방향", "결과 즉시 확인"] },
  }[label];
