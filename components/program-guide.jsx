  ...
  return <div className="program-guide program-guide-compact">
    <section className="subpage-block" id="choose"><div className="wrap guide-visual-row">
      <div>
        ...
        <details className="guide-storage"><summary>로그인 없이 시작할 수 있나요?</summary><p>문제 연습은 로그인 없이 시작할 수 있습니다. 일부 단원·번호 연습은 회차 결과로 저장되지 않으니, 시작 화면의 저장 안내를 확인해 주세요.</p></details>
      </div>
    ...
    <section className="subpage-block subpage-tint" id="retry"><div className="wrap guide-visual-row">
      <div id="handwriting">
        ...
        <details className="guide-storage"><summary>손풀이 이용·저장 안내</summary><p>손풀이는 로그인 후 이용하며, 무료 계정의 채점에는 하루 이용 한도가 있습니다. 앱이 읽어낸 답을 확인·수정해 제출하면 풀이가 저장됩니다.</p><p>제출 전 필기는 문제 이동이나 새로고침 때 사라질 수 있습니다. 채점은 제출 답을 정답과 비교하며, 풀이의 모든 단계를 확인하는 기능은 아닙니다.</p></details>
      </div>
    ...
    <section className="subpage-block" id="review"><div className="wrap guide-visual-row">
      <div>
        ...
        <details className="guide-storage"><summary>복습 기록은 어떻게 남나요?</summary><p>시험지 한 회를 완료한 뒤 로그인하고 ‘계정 저장’을 선택하면 결과가 남습니다. 문항별 풀이 시간은 사용한 기기의 브라우저에 남습니다.</p><p>‘오래 걸린 문항 다시 보기’로 연습할 수 있지만, 그 재풀이 결과는 별도로 저장되지 않습니다. 틀린 이유는 해설과 자신의 풀이를 비교해 직접 확인해 주세요.</p></details>
      </div>
